...
def run():
        ...
        def get_data_from_link(self,links):
            ...
            for link in links:
                ...
                try:
                    ...
                    filename = "dog" + "_" + name_filename + "_paluch"
    ...
    for page in range(1,52):
        grabberPsy = grabberPaluch('czekam_na_ciebie:{}/?sea=1&f[species_id]=1'.format(page))
        links = grabberPsy.get_links()
        koty = grabberPsy.get_data_from_link(links)
