...
def run():
        ...
        def get_data_from_link(self,links):
            ...
            for link in links:
                ...
                try:
                    ...
                    filename = "dog" + "_" + name_filename + "_milanowek"
    ...
    for page in range(1,10):
        grabberPsy = grabberMilanowek('/index.php?option=com_sobipro&sid=55&site={}&Itemid=11'.format(page))
        links = grabberPsy.get_links()
        psy = grabberPsy.get_data_from_link(links)
